...
COPY server.py server_core.py media_metadata.py ai_service.py observability.py database.py saas_models.py job_queue.py auth_service.py auth_routes.py admin_routes.py email_service.py billing_service.py billing_routes.py payment_service.py payment_routes.py yookassa_client.py manage_users.py workspace_service.py workspace_routes.py content_routes.py ./
COPY alembic.ini ./
